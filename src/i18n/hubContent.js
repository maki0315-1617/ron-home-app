...
const content = {
  ja: {
    ...
    vercelLinks: [
      ...
      { title: "📅 ロンスケ＋ジュール（デモ）", desc: "予定・服薬・健康記録・タスクを、ひとつの画面で管理する健康スケジュールアプリ（デモ）" },
  ...
  en: {
    ...
    vercelLinks: [
      ...
      { title: "📅 Ron Schedule+ (demo)", desc: "Health schedule app: plans, medication, health records, and tasks on one screen (demo)." },
